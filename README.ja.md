...
classifier v2 は recall 92.5%、specificity 85.0% を達成し、40 件の攻撃のうち 37 件を検出しつつ、安全な入力 40 件のうち 34 件を正しく通過させます。embedding は直接指示型への recall は 90% と高い一方、言い換え型への recall は 65% にとどまります。
